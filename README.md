...
| :--- | :--- | :--- | :--- | :--- |
| Caddy | `seatonjiang/caddy` | `ghcr.io/seatonjiang/caddy` <br> `docker.cnb.cool/seatonjiang/vsftpd/caddy` | alpine | 2026-03-16 |
| vsftpd | `seatonjiang/vsftpd` | `ghcr.io/seatonjiang/vsftpd` <br> `docker.cnb.cool/seatonjiang/vsftpd/vsftpd` | alpine | 2026-03-16 |
