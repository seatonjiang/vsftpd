...
| :--- | :--- | :--- | :--- | :--- |
| Caddy | `seatonjiang/caddy` | `docker.cnb.cool/seatonjiang/vsftpd/caddy` | alpine | 2026-09-01 |
| vsftpd | `seatonjiang/vsftpd` | `docker.cnb.cool/seatonjiang/vsftpd/vsftpd` | alpine | 2026-09-01 |
